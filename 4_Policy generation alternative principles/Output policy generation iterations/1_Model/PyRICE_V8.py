    ...
    def __call__(self,
        ...
        **kwargs):
        ...
        for t in range(1,11): 
            ...
            self.climate_impact_relative_to_capita[self.year] = ((self.damages[:,t] *  self.damage_share.transpose() * 10**12)/(0.2* self.region_pop[:,t]*10**6)) /(self.CPC_post_damage[self.year] * 1000)
