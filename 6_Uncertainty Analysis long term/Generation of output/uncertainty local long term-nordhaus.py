...
if __name__ == "__main__":
    print("uncertainty analysis started for: " + "nordhaus" + " case for " + str(nfe) + " scenario's")
    ...
    with MultiprocessingEvaluator(RICE) as evaluator:
        ...
        file_name =  save_folder + "results_uncertainty_analsysis_long_term_local_test_" + "nordhaus" +"_runs_" + str(nfe) + ".tar.gz"
        save_results(results, file_name)

        print("uncertainty_analysis_long_term " + "nordhaus" + " cycle completed")
