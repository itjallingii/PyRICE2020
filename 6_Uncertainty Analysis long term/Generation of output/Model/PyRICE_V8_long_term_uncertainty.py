...
class PyRICE(object):
    ...
    def __call__(self,
        ...
        **kwargs):
        ...
        GDP_ssp = pd.read_excel("Y_Gross_ssp.xlsx",header = None,dtype=float)
        ...
        ####################################################################
        """         
        #egalitarian objectives troubles with NaN NOT RESOLVED
        ...
        #BUG HEREWITH NAN VALUES NOT FIXED YET
